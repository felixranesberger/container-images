...
const computeResponsiveImageVariants = (sourceTag: HTMLSourceElement): ResponsiveImageVariants => {
  ...
  return Object.fromEntries(availableSources) as ResponsiveImageVariants
}
...
const initResponsiveImageLoading = (pictureTag: HTMLPictureElement) => {
  ...
  if (unsortedImageVariants === undefined)
    return
